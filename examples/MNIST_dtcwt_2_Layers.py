...
class Wavelets(nn.Module):
    def __init__(self, output_dim):
        ...
        self.Wl00 = nn.Parameter(torch.randn(1,6))
        self.Wh00 = nn.Parameter(torch.randn(1, 6))
        self.Wh01 = nn.Parameter(torch.randn(1, 6))
        self.Wh02 = nn.Parameter(torch.randn(1, 6))
...
wandb.init(project="MNIST_dtcwt_2layers")
