...
class Fourier(nn.Module):
    def __init__(self, output_dim):
        ...
        self.W1 = nn.Parameter(torch.randn(28, 28, 6, 1))
       

        self.W2 = nn.Parameter(torch.randn(14,14, 16, 6))
    ...
    def fourier_conv(self, x, W):
        ...
        x = torch.permute(x, (0, 2, 3, 1)).unsqueeze(-1)
    ...
    def forward(self, x):
       ...
       # x = [batch size, output dim]
        ...
        return x,h
wandb.init(project="MNIST_fourier_2layers")    
OUTPUT_DIM = 10
