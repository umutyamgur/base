...
class Wavelets(nn.Module):
    def __init__(self, output_dim):
        ...
        self.Wl00 = nn.Parameter(torch.randn(1,96))
        self.Wh00 = nn.Parameter(torch.randn(1, 96))
        self.Wh01 = nn.Parameter(torch.randn(1, 96))
        self.Wh02 = nn.Parameter(torch.randn(1, 96))
...
wandb.init(project="MNIST_dtcwt_7layers")
