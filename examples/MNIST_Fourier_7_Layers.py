...
class Fourier(nn.Module):
    def __init__(self, output_dim):
        ...
        self.W1 = nn.Parameter(torch.randn(28,28, 96, 1))
        self.W2 = nn.Parameter(torch.randn(28,28, 96, 96))
        self.W3 = nn.Parameter(torch.randn(14,14, 192, 96))
        self.W4 = nn.Parameter(torch.randn(14,14, 192, 192))
        self.W5 = nn.Parameter(torch.randn(7,7, 192, 192))
        self.W6 = nn.Parameter(torch.randn(7,7, 192, 192))
        self.W7 = nn.Parameter(torch.randn(7,7, 10, 192))

        # self.W1 = nn.Parameter(torch.randn(96, 3))
        # self.W2 = nn.Parameter(torch.randn(96, 96))
        # self.W3 = nn.Parameter(torch.randn(192, 96))
        # self.W4 = nn.Parameter(torch.randn(192, 192))
        # self.W5 = nn.Parameter(torch.randn(192, 192))
        # self.W6 = nn.Parameter(torch.randn(192, 192))
        # self.W7 = nn.Parameter(torch.randn(10, 192))
    ...
    def forward(self, x):
       ...
       # x = [batch size, output dim]
        ...
        return x,h
wandb.init(project="MNIST_Fourier_7layers")    
OUTPUT_DIM = 10
